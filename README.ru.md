...
с локальным распознаванием речи, двумя исправлениями стриминга, настраиваемым
промптом топика и функциями для работы то с компьютера, то с телефона: папки
проектов как топики, `/continue` и посты о новых сессиях. Точный список
